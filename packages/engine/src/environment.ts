...
/**
 * Isothermal exponential atmosphere, rho(y) = rho0*e^(-y/H) (§3.4). T, p,
 * eta, and c stay at their ISA sea-level values -- only density (the only
 * quantity the drag/buoyancy forces read) varies with altitude here.
 */
