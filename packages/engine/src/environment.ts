...
/**
 * Sinusoidal gust: w_x(t) = mean + amplitude*sin(angularFrequency*t + phase)
 * (§3.5 case 3), horizontal component only (wy = 0). Smooth by construction
 * (C^infty in t) so integrator convergence studies over it stay clean.
 */
